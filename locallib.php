 ...
 * @return false|string Returns binary Excel contents or false if an error occurred.
...
/**
 * Returns root category record in full category tree for a given category.
 *
 * @param int $category Category ID from where to start root category search.
 * @param array $categories Array of cached categories.
 * @return object|null Return course object or null if no root category was found.
 */
...
/**
 * Return list of all category objects prepended with top site-level category.
 *
 * @return object[] Indexed array by category ID.
 * @throws dml_exception
...
/**
 * Returns translated module title by a given module name.
 *
 * @param string $modulename Module name.
 * @param array $modulecache An array reference that points to an array of cached module translations.
